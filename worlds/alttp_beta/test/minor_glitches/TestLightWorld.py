...
class TestLightWorld(TestMinor):
    ...
    def testLightWorld(self):
        self.run_location_tests([
            ...
            ["Mini Moldorm Cave - Far Left", True, ['Bomb Upgrade (+5)']],
            ["Mini Moldorm Cave - Left", True, ['Bomb Upgrade (+5)']],
            ["Mini Moldorm Cave - Right", True, ['Bomb Upgrade (+5)']],
            ["Mini Moldorm Cave - Far Right", True, ['Bomb Upgrade (+5)']],
            ["Mini Moldorm Cave - Generous Guy", True, ['Bomb Upgrade (+5)']],
