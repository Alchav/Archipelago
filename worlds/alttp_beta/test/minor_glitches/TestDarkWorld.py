...
class TestDarkWorld(TestMinor):
    ...
    def testEastDarkWorld(self):
        self.run_location_tests([
            ...
            ["Pyramid Fairy - Left", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Hammer']],
            ["Pyramid Fairy - Left", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Progressive Glove', 'Hammer']],
            ["Pyramid Fairy - Left", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Progressive Glove', 'Progressive Glove', 'Magic Mirror']],
            ["Pyramid Fairy - Left", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Progressive Glove', 'Hookshot', 'Magic Mirror']],
            ["Pyramid Fairy - Left", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Flippers', 'Hookshot', 'Magic Mirror']],
            ...
            ["Pyramid Fairy - Right", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Hammer']],
            ["Pyramid Fairy - Right", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Progressive Glove', 'Hammer']],
            ["Pyramid Fairy - Right", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Progressive Glove', 'Progressive Glove', 'Magic Mirror']],
            ["Pyramid Fairy - Right", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Progressive Glove', 'Hookshot', 'Magic Mirror']],
            ["Pyramid Fairy - Right", True, ['Moon Pearl', 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Beat Agahnim 1', 'Flippers', 'Hookshot', 'Magic Mirror']],
