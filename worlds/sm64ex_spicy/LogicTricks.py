logic_tricks = {
    ...
    "Castle Third Tree From Waterfall 1-Up With No Movement": {
        "internal_id": "logic_castle_waterfall_tree_1up_with_no_movement",
        "rule": "",
        "difficulty": "medium",
    ...
    "Castle Secret Aquarium Entrance with Triple Jump Only": {
        "internal_id": "logic_secret_aquarium_triple_jump",
        "rule": "TJ",
        "difficulty": "medium",
        "description": "Reaching the Secret Aquarium entrance (and Jolly Roger Bay Lobby 1-Up)"
                       "using only Triple Jump.",
        "video": "https://www.youtube.com/watch?v=faGeJxsqcyg"
    },
    "Castle Secret Aquarium Entrance with Wall Kick and Ledge Grab": {
        "internal_id": "logic_secret_aquarium_wall_kick_and_ledge_grab",
        "rule": "WK+LG",
        "difficulty": "medium",
        "description": "Reaching the Secret Aquarium entrance (and Jolly Roger Bay Lobby 1-Up)"
                       "using only Wall Kick and Ledge Grab.",
        "video": "https://www.youtube.com/watch?v=g3rWZrOZdn4"
    },
    "Castle Secret Aquarium Entrance with Wall Kick": {
        "internal_id": "logic_secret_aquarium_wall_kick",
        "rule": "WK",
        "difficulty": "hard",
        "description": "Reaching the Secret Aquarium entrance (and Jolly Roger Bay Lobby 1-Up)"
                       "using only Wall Kick.",
        "video": "https://www.youtube.com/watch?v=Ngfv3j_SzJc"
    },
    "Castle Secret Aquarium Entrance with Ledge Grab": {
        "internal_id": "logic_secret_aquarium_ledge_grab",
        "rule": "LG",
        "difficulty": "hard",
        "description": "Reaching the Secret Aquarium entrance (and Jolly Roger Bay Lobby 1-Up)"
                       "using only Ledge Grab.",
        "video": "https://www.youtube.com/watch?v=1mwNHXIAFbI"
    },
    "Castle MIPS Without Dive": {
        "internal_id": "logic_castle_mips_without_dive",
        "rule": "",
        "difficulty": "easy",
    ...
    "Castle Tick Tock Clock Entrance With Wall Kick": {
        "internal_id": "logic_castle_ttc_with_wall_kick",
        "rule": "WK",
    ...
    "Castle Tick Tock Clock Entrance With Long Jump and Kick": {
        "internal_id": "logic_castle_ttc_with_long_jump_and_kick",
        "rule": "LJ+KK",
    ...
    "Castle Tick Tock Clock Entrance With Dive and Kick": {
        "internal_id": "logic_castle_ttc_with_dive_and_kick",
        "rule": "DV+KK",
    ...
    "Castle Third Floor Alcoves With Wall Kick": {
        "internal_id": "logic_castle_3f_alcoves_with_wall_kick",
        "rule": "WK",
    ...
    "Castle Third Floor Alcoves With Dive and Kick": {
        "internal_id": "logic_castle_3f_alcoves_with_dive_and_kick",
        "rule": "DV+KK",
    ...
    "Castle Third Floor Alcoves With Dive and Ledge Grab": {
        "internal_id": "logic_castle_3f_alcoves_with_dive_and_ledge_grab",
        "rule": "DV+LG",
    ...
    "Castle Third Floor Alcoves With Long Jump and Ledge Grab": {
        "internal_id": "logic_castle_3f_alcoves_with_long_jump_and_ledge_grab",
        "rule": "LJ+LG",
    ...
    "Castle Crackslide Through the 30 Star Door With Backflip, Kick, Double Jump, and Ledge grab": {
        "internal_id": "logic_castle_30_star_door_crackslide",
        "rule": "BF+KK+TJ+LG",
    ...
    "Castle Crackslide Through the 30 Star Door With Double Jump Setup": {
        "internal_id": "logic_castle_30_star_door_crackslide_double_jump",
        "rule": "TJ+LG",
    ...
    "Castle Crackslide Through the 30 Star Door With YOLO Setup": {
        "internal_id": "logic_castle_30_star_door_crackslide_yolo",
        "rule": "LG+BF",
    ...
    "Castle Backwards Long Jump Through the 50 Star Door": {
        "internal_id": "logic_castle_50_star_door_blj",
        "rule": "LJ",
    ...
    "Castle Backwards Long Jump Through the 70 Star Door": {
        "internal_id": "logic_castle_70_star_door_blj",
        "rule": "LJ",
    ...
    "Bob-omb Battlefield Island with Wing Cap": {
        "internal_id": "logic_bob_island_without_cannon",
        "rule": "WC+TJ",
        "difficulty": "easy",
    ...
    "Bob-omb Battlefield Mario Wings to the Sky without Wing Cap": {
        "internal_id": "logic_bob_mario_wings_capless",
        "rule": "CANN",
        "difficulty": "medium",
    ...
    "Bob-omb Battlefield Mario Wings to the Sky without Cannon": {
        "internal_id": "logic_bob_mario_wings_to_the_sky_without_cannon",
        "rule": "WC+TJ+GP",
        "difficulty": "hard",
    ...
    "Bob-omb Battlefield Mario Wings to the Sky without Coin Markers": {
        "internal_id": "logic_bob_mario_wings_without_coin_markers",
        "rule": "",
        "difficulty": "hard",
    ...
    "Bob-omb Battlefield Island with Koopa Shell": {
        "internal_id": "logic_bob_island_koopa_shell",
        "rule": "KOOPA_TROOPA",
        "difficulty": "hard",
    ...
    "Bob-omb Battlefield Chain Chomp Gate with Bob-omb Clip": {
        "internal_id": "logic_bob_chain_chomp_gate_without_ground_pound",
        "rule": "BOBOMBS",
        "difficulty": "hard",
    ...
    "Whomp's Fortress Caged Island With Long Jump From on Top of Whomp King's Head": {
        "internal_id": "logic_wf_caged_island_cage_wk_long_jump",
    ...
    "Whomp's Fortress Caged Island With Jump Off of Whomp King": {
        "internal_id": "logic_wf_caged_island_cage_wk_jump",
    ...
    "Whomp's Fortress Caged Island from the Top of the Fortress with Long Jump": {
        "internal_id": "logic_wf_caged_island_top_fortress_long_jump",
    ...
    "Whomp's Fortress Top Access with Side Flip and Ledge Grab Off of Whomp": {
        "internal_id": "logic_wf_caged_top_access_with_sf_lg",
        "rule": "WHOMPS+SF+LG",
        "difficulty": "medium",
    ...
    "Whomp's Fortress Top Access with Triple Jump Off of Whomp": {
        "internal_id": "logic_wf_caged_top_access_with_tj",
        "rule": "WHOMPS+TJ",
        "difficulty": "hard",
    ...
    "Whomp's Fortress Blast Away the Wall with Backflip and Ledge Grab": {
        "internal_id": "logic_wf_blast_away_wall_cannonless_backflip",
        "rule": "BF+LG",
        "difficulty": "hard",
    ...
    "Whomp's Fortress Blast Away the Wall with Ledge Grab": {
        "internal_id": "logic_wf_blast_away_wall_cannonless",
        "rule": "LG",
        "difficulty": "hard",
    ...
    "Whomp's Fortress Shoot Into the Wild Blue with Triple Jump or Side Flip, and Wall Kick": {
        "internal_id": "logic_wf_into_the_wild_blue_yonder_wall_kick",
        "rule": "WK & TJ/SF",
        "difficulty": "easy",
    ...
    "Whomp's Fortress Shoot Into the Wild Blue with Long Jump": {
        "internal_id": "logic_wf_into_the_wild_blue_yonder_long_jump",
        "rule": "LJ",
        "difficulty": "medium",
    ...
    "Whomp's Fortress Shoot Into the Wild Blue with Jump": {
        "internal_id": "logic_wf_into_the_wild_blue_yonder_moveless",
        "rule": "",
        "difficulty": "hard",
    ...
    "Jolly Roger Bay Upper Platform with Cannon": {
        "internal_id": "logic_jrb_upper_cannon",
        "rule": "CANN",
        "difficulty": "easy",
    ...
    "Jolly Roger Bay Pillar Red Coin with Cannon": {
        "internal_id": "logic_jrb_pillar_red_coin_cannon",
        "rule": "CANN",
        "difficulty": "medium",
    ...
    "Jolly Roger Bay Stone Pillar without Cannon": {
        "internal_id": "logic_jrb_stone_pillar_cannonless",
        "rule": "",
        "difficulty": "hard",
    ...
    "Jolly Roger Bay Stone Pillar with Cannon but without Climb": {
        "internal_id": "logic_jrb_stone_pillar_cannon_no_climb",
        "rule": "CANN",
        "difficulty": "medium",
    ...
    "Jolly Roger Bay Through the Jet Stream without Metal Cap": {
        "internal_id": "logic_jrb_jet_stream_capless",
        "rule": "",
        "difficulty": "medium",
    ...
    "Jolly Roger Bay Ship Red Coin With Long Jump": {
        "internal_id": "logic_jrb_ship_red_coin_with_long_jump",
        "rule": "LJ",
        "difficulty": "easy",
    ...
    "Cool, Cool Mountain Wall Kicks Will Work With Spin Jump": {
        "internal_id": "logic_ccm_wall_kicks_will_work_spin_jump",
        "rule": "SPINDRIFTS",
        "difficulty": "medium",
    ...
    "Big Boo's Haunt Third Floor with Side Flip and Bounce Off of Bookends": {
        "internal_id": "logic_bbh_third_floor_side_flip",
        "rule": "SF+FLYING_BOOKENDS",
        "difficulty": "hard",
    ...
    "Big Boo's Haunt Roof without Long Jump": {
        "internal_id": "logic_bbh_roof_without_long_jump",
        "rule": "",
        "difficulty": "medium",
    ...
    "Deep Underwater Coins Without Metal Cap": {
        "internal_id": "logic_cotmc_deep_underwater_coins_without_metal_cap",
        "rule": "",
        "difficulty": "medium",
    ...
    "Vanish Cap Under the Moat Drop to Checkerboard Platforms From Above": {
        "internal_id": "logic_vcutm_drop_to_checkerboard_platforms",
        "rule": "",
        "difficulty": "medium",
    ...
    "Vanish Cap Under the Moat Drop to Checkerboard Platforms From Above After Crawling Back Up the Slide": {
        "internal_id": "logic_vcutm_drop_to_checkerboard_platforms_after_crawling_back_up",
        "rule": "",
        "difficulty": "medium",
