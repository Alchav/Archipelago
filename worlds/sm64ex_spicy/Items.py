...
# These unlocks affect game behavior but intentionally do not participate in logic yet.
global_coin_object_item_data_table: dict[str, SM64ItemData] = {
    "Global Single Yellow Coins": SM64ItemData(3626560, useful),
    "Global Red Coins": SM64ItemData(3626561, useful),
    "Global Moving Blue Coins": SM64ItemData(3626562, useful),
    "Global Blue Coin Switches": SM64ItemData(3626563, useful),
    "Global Horizontal Coin Lines": SM64ItemData(3626564, useful),
    "Global Horizontal Coin Rings": SM64ItemData(3626565, useful),
    "Global Coin Arrows": SM64ItemData(3626566, useful),
    "Global Floating Coin Lines": SM64ItemData(3626567, useful),
    "Global Vertical Coin Lines": SM64ItemData(3626568, useful),
    "Global Floating Coin Rings": SM64ItemData(3626569, useful),
    "Global Vertical Coin Rings": SM64ItemData(3626570, useful),
    "Global Breakable Coin Boxes": SM64ItemData(3626782, useful),
    "Global Throwable Cork Boxes": SM64ItemData(3626783, useful),
    "Global Crazy Boxes": SM64ItemData(3626784, useful),
    "Global Wooden Posts": SM64ItemData(3626785, useful),
    "Global One-Coin Blocks": SM64ItemData(3626815, useful),
    "Global Three-Coin Blocks": SM64ItemData(3626816, useful),
    "Global Ten-Coin Blocks": SM64ItemData(3626817, useful),
}


per_level_coin_object_item_data_table: dict[str, SM64ItemData] = {
    "Bowser in the Dark World - Single Yellow Coins": SM64ItemData(3626600, useful),
    "Bowser in the Fire Sea - Single Yellow Coins": SM64ItemData(3626601, useful),
    "Bowser in the Sky - Single Yellow Coins": SM64ItemData(3626602, useful),
    "Bob-omb Battlefield - Single Yellow Coins": SM64ItemData(3626603, useful),
    "Castle Grounds - Single Yellow Coins": SM64ItemData(3626604, useful),
    "Castle - Single Yellow Coins": SM64ItemData(3626605, useful),
    "Cool, Cool Mountain - Single Yellow Coins": SM64ItemData(3626606, useful),
    "Dire, Dire Docks - Single Yellow Coins": SM64ItemData(3626607, useful),
    "Hazy Maze Cave - Single Yellow Coins": SM64ItemData(3626608, useful),
    "Lethal Lava Land - Single Yellow Coins": SM64ItemData(3626609, useful),
    "Princess's Secret Slide - Single Yellow Coins": SM64ItemData(3626610, useful),
    "Rainbow Ride - Single Yellow Coins": SM64ItemData(3626611, useful),
    "Snowman's Land - Single Yellow Coins": SM64ItemData(3626612, useful),
    "Shifting Sand Land - Single Yellow Coins": SM64ItemData(3626613, useful),
    "Tiny-Huge Island - Single Yellow Coins": SM64ItemData(3626614, useful),
    "Tower of the Wing Cap - Single Yellow Coins": SM64ItemData(3626615, useful),
    "Tick Tock Clock - Single Yellow Coins": SM64ItemData(3626616, useful),
    "Tall, Tall Mountain - Single Yellow Coins": SM64ItemData(3626617, useful),
    "Vanish Cap Under the Moat - Single Yellow Coins": SM64ItemData(3626618, useful),
    "Whomp's Fortress - Single Yellow Coins": SM64ItemData(3626619, useful),
    "Big Boo's Haunt - Red Coins": SM64ItemData(3626620, useful),
    "Bowser in the Dark World - Red Coins": SM64ItemData(3626621, useful),
    "Bowser in the Fire Sea - Red Coins": SM64ItemData(3626622, useful),
    "Bowser in the Sky - Red Coins": SM64ItemData(3626623, useful),
    "Bob-omb Battlefield - Red Coins": SM64ItemData(3626624, useful),
    "Cool, Cool Mountain - Red Coins": SM64ItemData(3626625, useful),
    "Cavern of the Metal Cap - Red Coins": SM64ItemData(3626626, useful),
    "Dire, Dire Docks - Red Coins": SM64ItemData(3626627, useful),
    "Hazy Maze Cave - Red Coins": SM64ItemData(3626628, useful),
    "Jolly Roger Bay - Red Coins": SM64ItemData(3626629, useful),
    "Lethal Lava Land - Red Coins": SM64ItemData(3626630, useful),
    "Rainbow Ride - Red Coins": SM64ItemData(3626631, useful),
    "Secret Aquarium - Red Coins": SM64ItemData(3626632, useful),
    "Snowman's Land - Red Coins": SM64ItemData(3626633, useful),
    "Shifting Sand Land - Red Coins": SM64ItemData(3626634, useful),
    "Tiny-Huge Island - Red Coins": SM64ItemData(3626635, useful),
    "Tower of the Wing Cap - Red Coins": SM64ItemData(3626636, useful),
    "Tick Tock Clock - Red Coins": SM64ItemData(3626637, useful),
    "Tall, Tall Mountain - Red Coins": SM64ItemData(3626638, useful),
    "Vanish Cap Under the Moat - Red Coins": SM64ItemData(3626639, useful),
    "Wet-Dry World - Red Coins": SM64ItemData(3626640, useful),
    "Whomp's Fortress - Red Coins": SM64ItemData(3626641, useful),
    "Wing Mario Over the Rainbow - Red Coins": SM64ItemData(3626642, useful),
    "Cool, Cool Mountain - Moving Blue Coins": SM64ItemData(3626643, useful),
    "Tall, Tall Mountain - Moving Blue Coins": SM64ItemData(3626644, useful),
    "Big Boo's Haunt - Blue Coin Switches": SM64ItemData(3626645, useful),
    "Cool, Cool Mountain - Blue Coin Switches": SM64ItemData(3626646, useful),
    "Dire, Dire Docks - Blue Coin Switches": SM64ItemData(3626647, useful),
    "Hazy Maze Cave - Blue Coin Switches": SM64ItemData(3626648, useful),
    "Jolly Roger Bay - Blue Coin Switches": SM64ItemData(3626649, useful),
    "Princess's Secret Slide - Blue Coin Switches": SM64ItemData(3626650, useful),
    "Rainbow Ride - Blue Coin Switches": SM64ItemData(3626651, useful),
    "Shifting Sand Land - Blue Coin Switches": SM64ItemData(3626652, useful),
    "Tiny-Huge Island - Blue Coin Switches": SM64ItemData(3626653, useful),
    "Tick Tock Clock - Blue Coin Switches": SM64ItemData(3626654, useful),
    "Wet-Dry World - Blue Coin Switches": SM64ItemData(3626655, useful),
    "Whomp's Fortress - Blue Coin Switches": SM64ItemData(3626656, useful),
    "Bowser in the Dark World - Horizontal Coin Lines": SM64ItemData(3626657, useful),
    "Bowser in the Fire Sea - Horizontal Coin Lines": SM64ItemData(3626658, useful),
    "Bowser in the Sky - Horizontal Coin Lines": SM64ItemData(3626659, useful),
    "Bob-omb Battlefield - Horizontal Coin Lines": SM64ItemData(3626660, useful),
    "Cool, Cool Mountain - Horizontal Coin Lines": SM64ItemData(3626661, useful),
    "Cavern of the Metal Cap - Horizontal Coin Lines": SM64ItemData(3626662, useful),
    "Dire, Dire Docks - Horizontal Coin Lines": SM64ItemData(3626663, useful),
    "Hazy Maze Cave - Horizontal Coin Lines": SM64ItemData(3626664, useful),
    "Jolly Roger Bay - Horizontal Coin Lines": SM64ItemData(3626665, useful),
    "Lethal Lava Land - Horizontal Coin Lines": SM64ItemData(3626666, useful),
    "Princess's Secret Slide - Horizontal Coin Lines": SM64ItemData(3626667, useful),
    "Rainbow Ride - Horizontal Coin Lines": SM64ItemData(3626668, useful),
    "Snowman's Land - Horizontal Coin Lines": SM64ItemData(3626669, useful),
    "Shifting Sand Land - Horizontal Coin Lines": SM64ItemData(3626670, useful),
    ...
    "Tall, Tall Mountain - Horizontal Coin Lines": SM64ItemData(3626673, useful),
    "Vanish Cap Under the Moat - Horizontal Coin Lines": SM64ItemData(3626674, useful),
    "Wet-Dry World - Horizontal Coin Lines": SM64ItemData(3626675, useful),
    "Whomp's Fortress - Horizontal Coin Lines": SM64ItemData(3626676, useful),
    "Bowser in the Dark World - Horizontal Coin Rings": SM64ItemData(3626677, useful),
    "Bowser in the Fire Sea - Horizontal Coin Rings": SM64ItemData(3626678, useful),
    "Bob-omb Battlefield - Horizontal Coin Rings": SM64ItemData(3626679, useful),
    "Cavern of the Metal Cap - Horizontal Coin Rings": SM64ItemData(3626680, useful),
    "Dire, Dire Docks - Horizontal Coin Rings": SM64ItemData(3626681, useful),
    "Hazy Maze Cave - Horizontal Coin Rings": SM64ItemData(3626682, useful),
    "Jolly Roger Bay - Horizontal Coin Rings": SM64ItemData(3626683, useful),
    "Lethal Lava Land - Horizontal Coin Rings": SM64ItemData(3626684, useful),
    "Rainbow Ride - Horizontal Coin Rings": SM64ItemData(3626685, useful),
    "Secret Aquarium - Horizontal Coin Rings": SM64ItemData(3626686, useful),
    "Shifting Sand Land - Horizontal Coin Rings": SM64ItemData(3626687, useful),
    "Tall, Tall Mountain - Horizontal Coin Rings": SM64ItemData(3626688, useful),
    "Wet-Dry World - Horizontal Coin Rings": SM64ItemData(3626689, useful),
    "Whomp's Fortress - Horizontal Coin Rings": SM64ItemData(3626690, useful),
    "Wing Mario Over the Rainbow - Horizontal Coin Rings": SM64ItemData(3626691, useful),
    "Cool, Cool Mountain - Coin Arrows": SM64ItemData(3626692, useful),
    "Whomp's Fortress - Coin Arrows": SM64ItemData(3626693, useful),
    "Bowser in the Fire Sea - Floating Coin Lines": SM64ItemData(3626694, useful),
    "Hazy Maze Cave - Floating Coin Lines": SM64ItemData(3626695, useful),
    "Lethal Lava Land - Floating Coin Lines": SM64ItemData(3626696, useful),
    "Rainbow Ride - Floating Coin Lines": SM64ItemData(3626697, useful),
    "Snowman's Land - Floating Coin Lines": SM64ItemData(3626698, useful),
    "Shifting Sand Land - Floating Coin Lines": SM64ItemData(3626699, useful),
    "Tall, Tall Mountain - Floating Coin Lines": SM64ItemData(3626700, useful),
    "Bowser in the Fire Sea - Vertical Coin Lines": SM64ItemData(3626701, useful),
    "Cool, Cool Mountain - Vertical Coin Lines": SM64ItemData(3626702, useful),
    "Dire, Dire Docks - Vertical Coin Lines": SM64ItemData(3626703, useful),
    "Jolly Roger Bay - Vertical Coin Lines": SM64ItemData(3626704, useful),
    "Rainbow Ride - Vertical Coin Lines": SM64ItemData(3626705, useful),
    "Shifting Sand Land - Vertical Coin Lines": SM64ItemData(3626706, useful),
    "Tall, Tall Mountain - Vertical Coin Lines": SM64ItemData(3626707, useful),
    "Bowser in the Dark World - Floating Coin Rings": SM64ItemData(3626708, useful),
    "Bowser in the Fire Sea - Floating Coin Rings": SM64ItemData(3626709, useful),
    "Jolly Roger Bay - Floating Coin Rings": SM64ItemData(3626710, useful),
    "Rainbow Ride - Floating Coin Rings": SM64ItemData(3626711, useful),
    "Secret Aquarium - Floating Coin Rings": SM64ItemData(3626712, useful),
    "Shifting Sand Land - Floating Coin Rings": SM64ItemData(3626713, useful),
    "Wet-Dry World - Floating Coin Rings": SM64ItemData(3626714, useful),
    "Whomp's Fortress - Floating Coin Rings": SM64ItemData(3626715, useful),
    "Wing Mario Over the Rainbow - Floating Coin Rings": SM64ItemData(3626716, useful),
    "Bob-omb Battlefield - Vertical Coin Rings": SM64ItemData(3626717, useful),
    "Dire, Dire Docks - Vertical Coin Rings": SM64ItemData(3626718, useful),
    "Jolly Roger Bay - Vertical Coin Rings": SM64ItemData(3626719, useful),
    "Secret Aquarium - Vertical Coin Rings": SM64ItemData(3626720, useful),
    "Tower of the Wing Cap - Vertical Coin Rings": SM64ItemData(3626721, useful),
    "Wing Mario Over the Rainbow - Vertical Coin Rings": SM64ItemData(3626722, useful),
    "Big Boo's Haunt - Breakable Coin Boxes": SM64ItemData(3626796, useful),
    "Bob-omb Battlefield - Breakable Coin Box": SM64ItemData(3626797, useful),
    "Wet-Dry World - Breakable Coin Boxes": SM64ItemData(3626798, useful),
    "Bob-omb Battlefield - Throwable Cork Boxes": SM64ItemData(3626799, useful),
    "Shifting Sand Land - Throwable Cork Box": SM64ItemData(3626800, useful),
    "Whomp's Fortress - Throwable Cork Boxes": SM64ItemData(3626801, useful),
    "Big Boo's Haunt - Crazy Box": SM64ItemData(3626802, useful),
    "Lethal Lava Land - Crazy Box": SM64ItemData(3626803, useful),
    "Shifting Sand Land - Crazy Boxes": SM64ItemData(3626804, useful),
    "Tall, Tall Mountain - Crazy Box": SM64ItemData(3626805, useful),
    "Bob-omb Battlefield - Wooden Posts": SM64ItemData(3626806, useful),
    "Tiny-Huge Island - Wooden Posts": SM64ItemData(3626807, useful),
    "Lethal Lava Land - Bowser Puzzle": SM64ItemData(3626814, useful),
    "Big Boo's Haunt - One-Coin Block": SM64ItemData(3626818, useful),
    "Bowser in the Dark World - One-Coin Blocks": SM64ItemData(3626819, useful),
    "Bowser in the Fire Sea - One-Coin Blocks": SM64ItemData(3626820, useful),
    "Snowman's Land - One-Coin Blocks": SM64ItemData(3626821, useful),
    "Tiny-Huge Island - One-Coin Blocks": SM64ItemData(3626822, useful),
    "Tick Tock Clock - One-Coin Blocks": SM64ItemData(3626823, useful),
    "Vanish Cap Under the Moat - One-Coin Block": SM64ItemData(3626824, useful),
    "Wet-Dry World - One-Coin Block": SM64ItemData(3626825, useful),
    "Bowser in the Dark World - Three-Coin Block": SM64ItemData(3626826, useful),
    "Bowser in the Fire Sea - Three-Coin Block": SM64ItemData(3626827, useful),
    "Jolly Roger Bay - Three-Coin Block": SM64ItemData(3626828, useful),
    "Snowman's Land - Three-Coin Block": SM64ItemData(3626829, useful),
    ...
    "Vanish Cap Under the Moat - Three-Coin Block": SM64ItemData(3626832, useful),
    "Wet-Dry World - Three-Coin Blocks": SM64ItemData(3626833, useful),
    "Big Boo's Haunt - Ten-Coin Block": SM64ItemData(3626834, useful),
    "Bowser in the Fire Sea - Ten-Coin Block": SM64ItemData(3626835, useful),
    "Tick Tock Clock - Ten-Coin Blocks": SM64ItemData(3626836, useful),
    "Wet-Dry World - Ten-Coin Blocks": SM64ItemData(3626837, useful),
}


global_enemy_item_data_table: dict[str, SM64ItemData] = {
    "Global Bob-ombs": SM64ItemData(3626571, useful),
    "Global Boos": SM64ItemData(3626572, useful),
    "Global Bullies": SM64ItemData(3626573, useful),
    "Global Chuckyas": SM64ItemData(3626574, useful),
    "Global Enemy Lakitus": SM64ItemData(3626575, useful),
    "Global Fire Piranha Plants": SM64ItemData(3626576, useful),
    "Global Fly Guys": SM64ItemData(3626577, useful),
    "Global Goombas": SM64ItemData(3626578, useful),
    "Global Koopa Troopas": SM64ItemData(3626579, useful),
    "Global Mr Blizzards": SM64ItemData(3626580, useful),
    "Global Mr. Is": SM64ItemData(3626581, useful),
    "Global Scuttlebugs": SM64ItemData(3626582, useful),
    "Global Snufits": SM64ItemData(3626583, useful),
    "Global Spindrifts": SM64ItemData(3626584, useful),
    "Global Whomps": SM64ItemData(3626585, useful),
    "Global Monty Moles": SM64ItemData(3626838, useful),
    "Global Big Bully": SM64ItemData(3626839, useful),
}


per_level_enemy_item_data_table: dict[str, SM64ItemData] = {
    "Bowser in the Fire Sea - Bob-omb": SM64ItemData(3626723, useful),
    "Bowser in the Sky - Bob-ombs": SM64ItemData(3626724, useful),
    "Bob-omb Battlefield - Bob-ombs": SM64ItemData(3626725, useful),
    "Rainbow Ride - Bob-ombs": SM64ItemData(3626726, useful),
    "Shifting Sand Land - Bob-ombs": SM64ItemData(3626727, useful),
    "Tick Tock Clock - Bob-ombs": SM64ItemData(3626728, useful),
    "Tall, Tall Mountain - Bob-ombs": SM64ItemData(3626729, useful),
    "Big Boo's Haunt - Boos": SM64ItemData(3626730, useful),
    "Bowser in the Fire Sea - Bullies": SM64ItemData(3626733, useful),
    "Lethal Lava Land - Bullies": SM64ItemData(3626734, useful),
    "Bowser in the Sky - Chuckya": SM64ItemData(3626735, useful),
    "Rainbow Ride - Chuckya": SM64ItemData(3626736, useful),
    "Tiny-Huge Island - Chuckya": SM64ItemData(3626737, useful),
    "Tall, Tall Mountain - Chuckya": SM64ItemData(3626738, useful),
    "Wet-Dry World - Chuckya": SM64ItemData(3626739, useful),
    "Rainbow Ride - Enemy Lakitus": SM64ItemData(3626740, useful),
    "Tiny-Huge Island - Enemy Lakitu": SM64ItemData(3626741, useful),
    "Shifting Sand Land - Eyerok": SM64ItemData(3626742, useful),
    "Bowser in the Sky - Fire Piranha Plants": SM64ItemData(3626743, useful),
    "Tiny-Huge Island - Fire Piranha Plants": SM64ItemData(3626744, useful),
    "Rainbow Ride - Fly Guy": SM64ItemData(3626745, useful),
    "Snowman's Land - Fly Guy": SM64ItemData(3626746, useful),
    "Shifting Sand Land - Fly Guy": SM64ItemData(3626747, useful),
    "Tiny-Huge Island - Fly Guy": SM64ItemData(3626748, useful),
    "Tall, Tall Mountain - Fly Guy": SM64ItemData(3626749, useful),
    "Big Boo's Haunt - Flying Bookends": SM64ItemData(3626750, useful),
    "Bowser in the Dark World - Goombas": SM64ItemData(3626751, useful),
    "Bowser in the Fire Sea - Goombas": SM64ItemData(3626752, useful),
    "Bowser in the Sky - Goombas": SM64ItemData(3626753, useful),
    "Bob-omb Battlefield - Goombas": SM64ItemData(3626754, useful),
    "Jolly Roger Bay - Goombas": SM64ItemData(3626755, useful),
    "Rainbow Ride - Goomba": SM64ItemData(3626756, useful),
    "Snowman's Land - Goombas": SM64ItemData(3626757, useful),
    "Shifting Sand Land - Goombas": SM64ItemData(3626758, useful),
    "Tiny-Huge Island - Goombas": SM64ItemData(3626759, useful),
    "Tall, Tall Mountain - Goombas": SM64ItemData(3626760, useful),
    "Bob-omb Battlefield - Koopa Troopa": SM64ItemData(3626761, useful),
    "Tiny-Huge Island - Koopa Troopa": SM64ItemData(3626762, useful),
    "Snowman's Land - Moneybags": SM64ItemData(3626763, useful),
    "Cool, Cool Mountain - Mr Blizzards": SM64ItemData(3626764, useful),
    "Snowman's Land - Mr Blizzards": SM64ItemData(3626765, useful),
    "Big Boo's Haunt - Mr. Is": SM64ItemData(3626766, useful),
    "Hazy Maze Cave - Mr. Is": SM64ItemData(3626767, useful),
    "Lethal Lava Land - Mr. Is": SM64ItemData(3626768, useful),
    "Whomp's Fortress - Piranha Plants": SM64ItemData(3626769, useful),
    "Shifting Sand Land - Pokeys": SM64ItemData(3626770, useful),
    "Big Boo's Haunt - Scuttlebugs": SM64ItemData(3626771, useful),
    "Hazy Maze Cave - Scuttlebugs": SM64ItemData(3626772, useful),
    "Wet-Dry World - Skeeters": SM64ItemData(3626773, useful),
    "Cavern of the Metal Cap - Snufits": SM64ItemData(3626774, useful),
    "Hazy Maze Cave - Snufits": SM64ItemData(3626775, useful),
    "Cool, Cool Mountain - Spindrifts": SM64ItemData(3626776, useful),
    "Snowman's Land - Spindrifts": SM64ItemData(3626777, useful),
    "Hazy Maze Cave - Swoops": SM64ItemData(3626778, useful),
    "Bowser in the Sky - Whomp": SM64ItemData(3626779, useful),
    "Whomp's Fortress - Whomps": SM64ItemData(3626780, useful),
    "Hazy Maze Cave - Monty Mole": SM64ItemData(3626840, useful),
    "Tall, Tall Mountain - Monty Moles": SM64ItemData(3626841, useful),
    "Lethal Lava Land - Big Bullies": SM64ItemData(3626842, useful),
    "Snowman's Land - Chill Bully": SM64ItemData(3626843, useful),
}


global_mode_coin_object_item_names = (
    "Global Single Yellow Coins",
    "Global Red Coins",
    "Global Moving Blue Coins",
    "Global Blue Coin Switches",
    "Global Horizontal Coin Lines",
    "Global Horizontal Coin Rings",
    "Global Coin Arrows",
    "Global Floating Coin Lines",
    "Global Vertical Coin Lines",
    "Global Floating Coin Rings",
    "Global Vertical Coin Rings",
    "Global Breakable Coin Boxes",
    "Global Throwable Cork Boxes",
    "Global Crazy Boxes",
    "Global Wooden Posts",
    "Global One-Coin Blocks",
    "Global Three-Coin Blocks",
    "Global Ten-Coin Blocks",
...
global_mode_enemy_item_names = (
    ...
    "Global Bullies",
    "Global Chuckyas",
    "Global Enemy Lakitus",
    "Global Fire Piranha Plants",
    "Global Fly Guys",
    "Global Goombas",
    "Global Koopa Troopas",
    "Global Mr Blizzards",
    "Global Mr. Is",
    "Global Scuttlebugs",
    "Global Snufits",
