...
class TestTickTockClockMovingLocations(SM64TestBase):
    ...
    def test_locations(self):
        self.run_location_tests([
            ...
            ["Tick Tock Clock - Midway Up Block 1-Up", False, TOP],
            ["Tick Tock Clock - Midway Up Block 1-Up", True,
             TOP + ["Tick Tock Clock - Spinners"]],
            ["Tick Tock Clock - Midway Up 1-Up Block", False, TOP],
            ["Tick Tock Clock - Midway Up 1-Up Block", True,
             TOP + ["Tick Tock Clock - Spinners"]],
