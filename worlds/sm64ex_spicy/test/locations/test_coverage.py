...
from ...Locations import coinsanity_location_table, location_table


class TestDeclarativeLocationCoverage(unittest.TestCase):
    def test_every_non_coinsanity_location_has_a_declarative_test(self):
        expected_locations = set(location_table).difference(coinsanity_location_table)
