...
class RomTable:
    ...
    def generate_pairs(self, options: PaperMarioOptions, placed_items, placed_blocks: dict, entrances: list,
...
def get_dbtuples(options: PaperMarioOptions, mystery_opts: MysteryOptions, required_spirits: list,
    ...
    for rom_option, ap_option in ap_to_rom_option_table.items():
        ...
        if ap_option == "":
            ...
            elif rom_option in ("StartingBoots", "StartingHammer"):
                option_value = -1
            ...
            elif rom_option == "ProgressiveScaling":
            ...
            elif rom_option == "AllowPhysicsGlitches":
                option_value = not options.prevent_ooblzs.value
            elif rom_option == "StarBeamArea":
