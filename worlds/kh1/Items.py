...
item_table: Dict[str, KH1ItemData] = {
    ...
    "Torn Page":                         KH1ItemData("Torn Pages",       code = 264_1009, classification = ItemClassification.progression_deprioritized_skip_balancing, type = "Item",           max_quantity = 5 ),
    ...
    "Jungle King":                       KH1ItemData("Keyblades",        code = 264_1086, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Three Wishes":                      KH1ItemData("Keyblades",        code = 264_1087, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Fairy Harp":                        KH1ItemData("Keyblades",        code = 264_1088, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Pumpkinhead":                       KH1ItemData("Keyblades",        code = 264_1089, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Crabclaw":                          KH1ItemData("Keyblades",        code = 264_1090, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Divine Rose":                       KH1ItemData("Keyblades",        code = 264_1091, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Spellbinder":                       KH1ItemData("Keyblades",        code = 264_1092, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Olympia":                           KH1ItemData("Keyblades",        code = 264_1093, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Lionheart":                         KH1ItemData("Keyblades",        code = 264_1094, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Metal Chocobo":                     KH1ItemData("Keyblades",        code = 264_1095, classification = ItemClassification.useful,      type = "Item",                            ),
    "Oathkeeper":                        KH1ItemData("Keyblades",        code = 264_1096, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Oblivion":                          KH1ItemData("Keyblades",        code = 264_1097, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Lady Luck":                         KH1ItemData("Keyblades",        code = 264_1098, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Wishing Star":                      KH1ItemData("Keyblades",        code = 264_1099, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    ...
    "Fire Arts":                         KH1ItemData("Key",              code = 264_1158, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Blizzard Arts":                     KH1ItemData("Key",              code = 264_1159, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Thunder Arts":                      KH1ItemData("Key",              code = 264_1160, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Cure Arts":                         KH1ItemData("Key",              code = 264_1161, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Gravity Arts":                      KH1ItemData("Key",              code = 264_1162, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Stop Arts":                         KH1ItemData("Key",              code = 264_1163, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Aero Arts":                         KH1ItemData("Key",              code = 264_1164, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    ...
    "Puppy":                             KH1ItemData("Key",              code = 264_1167, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    ...
    "Progressive Fire":                  KH1ItemData("Magic",            code = 264_1175, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Progressive Blizzard":              KH1ItemData("Magic",            code = 264_1176, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Progressive Thunder":               KH1ItemData("Magic",            code = 264_1177, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Progressive Cure":                  KH1ItemData("Magic",            code = 264_1178, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Progressive Gravity":               KH1ItemData("Magic",            code = 264_1179, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Progressive Stop":                  KH1ItemData("Magic",            code = 264_1180, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Progressive Aero":                  KH1ItemData("Magic",            code = 264_1181, classification = ItemClassification.progression_deprioritized, type = "Item",           max_quantity = 3 ),
    "Phil Cup":                          KH1ItemData("Cups",             code = 264_1182, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Theon Vol. 6":                      KH1ItemData("Key",              code = 264_1183, classification = ItemClassification.progression, type = "Item",                            ),
    "Pegasus Cup":                       KH1ItemData("Cups",             code = 264_1184, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Hercules Cup":                      KH1ItemData("Cups",             code = 264_1185, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    ...
    "Emblem Piece (Flame)":              KH1ItemData("Key",              code = 264_1188, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Emblem Piece (Chest)":              KH1ItemData("Key",              code = 264_1189, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Emblem Piece (Statue)":             KH1ItemData("Key",              code = 264_1190, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Emblem Piece (Fountain)":           KH1ItemData("Key",              code = 264_1191, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
   ...
   #"Torn Page 5":                       KH1ItemData("Torn Pages",       code = 264_1216, classification = ItemClassification.progression, type = "Item",                            ),
    ...
    "Bambi":                             KH1ItemData("Summons",          code = 264_1233, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Genie":                             KH1ItemData("Summons",          code = 264_1234, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Tinker Bell":                       KH1ItemData("Summons",          code = 264_1235, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Mushu":                             KH1ItemData("Summons",          code = 264_1236, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Simba":                             KH1ItemData("Summons",          code = 264_1237, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    "Lucky Emblem":                      KH1ItemData("Key",              code = 264_1238, classification = ItemClassification.progression_deprioritized, type = "Item",                            ),
    ...
    "Mythril":                           KH1ItemData("Key",              code = 264_1254, classification = ItemClassification.progression_deprioritized_skip_balancing, type = "Item",           max_quantity = 16),
    "Orichalcum":                        KH1ItemData("Key",              code = 264_1255, classification = ItemClassification.progression_deprioritized_skip_balancing, type = "Item",           max_quantity = 17),
    "High Jump":                         KH1ItemData("Shared Abilities", code = 264_2001, classification = ItemClassification.progression_deprioritized, type = "Shared Ability",                  ),
    "Mermaid Kick":                      KH1ItemData("Shared Abilities", code = 264_2002, classification = ItemClassification.progression_deprioritized, type = "Shared Ability",                  ),
    "Progressive Glide":                 KH1ItemData("Shared Abilities", code = 264_2003, classification = ItemClassification.progression_deprioritized, type = "Shared Ability", max_quantity = 2 ),
    ...
    "Air Combo Plus":                    KH1ItemData("Abilities",        code = 264_3007, classification = ItemClassification.progression_deprioritized, type = "Ability",        max_quantity = 2 ),
    ...
    "Sonic Blade":                       KH1ItemData("Abilities",        code = 264_3011, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    "Ars Arcanum":                       KH1ItemData("Abilities",        code = 264_3012, classification = ItemClassification.useful,      type = "Ability",                         ),
    "Strike Raid":                       KH1ItemData("Abilities",        code = 264_3013, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    ...
    "Counterattack":                     KH1ItemData("Abilities",        code = 264_3019, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    "Blitz":                             KH1ItemData("Abilities",        code = 264_3020, classification = ItemClassification.useful,      type = "Ability",                         ),
    "Guard":                             KH1ItemData("Abilities",        code = 264_3021, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    "Dodge Roll":                        KH1ItemData("Abilities",        code = 264_3022, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    "MP Haste":                          KH1ItemData("Abilities",        code = 264_3023, classification = ItemClassification.useful,      type = "Ability",                         ),
    "MP Rage":                           KH1ItemData("Abilities",        code = 264_3024, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    "Second Chance":                     KH1ItemData("Abilities",        code = 264_3025, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    ...
    "Leaf Bracer":                       KH1ItemData("Abilities",        code = 264_3062, classification = ItemClassification.progression_deprioritized, type = "Ability",                         ),
    ...
    "Combo Master":                      KH1ItemData("Abilities",        code = 264_3065, classification = ItemClassification.progression_deprioritized, type = "Ability",                         )
}
