...
def set_rules(world: MultiWorld, player: int):
    ...
    set_rule(world.get_location("Card Draw 15", player), lambda state: state._spire_has_items(player, 26))
    ...
    set_rule(world.get_location("Relic 10", player), lambda state: state._spire_has_items(player, 28))

    # Act 3 Boss Event
    set_rule(world.get_location("Act 3 Boss", player), lambda state: state._spire_has_items(player, 29))

    set_rule(world.get_location("Heart Room", player), lambda state: state._spire_has_items(player, 29))
