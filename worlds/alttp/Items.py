...
item_table = {'Bow': ItemData(True, None, 0x0B, 'You have\nchosen the\narcher class.', 'the stick and twine', 'arrow-slinging kid', 'arrow sling for sale', 'witch and robin hood', 'archer boy shoots again', 'the Bow'),
              ...
              'Magic Jar': ItemData(False, None, 0xB3, 'An instant magic refill', 'disappointment jar', 'magic refill boy', 'quick magic for sale', 'magic shop indeed', 'magic boy saves magic again', 'a magic refill'),
              'Apple': ItemData(False, None, 0xB4, 'Forbidden fruit', 'the ancient fruit', 'johnny appleseed', 'zora\'s fruit stand', 'fruit for fungus', 'apple farmer eats again', 'apples'),
