...
item_table = {'Bow': ItemData(IC.progression, None, 0x0B, 'You have\nchosen the\narcher class.', 'the stick and twine', 'arrow-slinging kid', 'arrow sling for sale', 'witch and robin hood', 'archer boy shoots again', 'the Bow'),
              ...
              'Small Magic Jar': ItemData(IC.filler, None, 0x45, '', '', '','', '', '', ''),
              'Apple': ItemData(IC.filler, None, 0xB4, '', '', 'Johnny Appleseed','', '', '', ''),
              'Exploding Triforce Piece': ItemData(IC.trap, None, 0xB5, '', '', '','', '', '', ''),
              'Fighter Sword and Shield': ItemData(IC.progression, None, 0x00, '', '', '','', '', '', ''),
