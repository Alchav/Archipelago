...
class TestDungeons(TestInvertedOWG):
    ...
    def testFirstDungeonChests(self):
        self.run_location_tests([
            ...
            ["Ganons Tower - Hope Room - Left", False, [], ['Crystal (Palace of Darkness)']],
            ["Ganons Tower - Hope Room - Left", False, [], ['Crystal (Swamp Palace)']],
            ["Ganons Tower - Hope Room - Left", False, [], ['Crystal (Skull Woods)']],
            ["Ganons Tower - Hope Room - Left", False, [], ["Crystal (Thieves' Town)"]],
            ["Ganons Tower - Hope Room - Left", False, [], ['Crystal (Ice Palace)']],
            ["Ganons Tower - Hope Room - Left", False, [], ['Crystal (Misery Mire)']],
            ["Ganons Tower - Hope Room - Left", False, [], ['Crystal (Turtle Rock)']],
            ["Ganons Tower - Hope Room - Left", True, ['Beat Agahnim 1', 'Crystal (Palace of Darkness)', 'Crystal (Swamp Palace)', 'Crystal (Skull Woods)', "Crystal (Thieves' Town)", 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Crystal (Turtle Rock)']],
            ["Ganons Tower - Hope Room - Left", True, ['Pegasus Boots', 'Magic Mirror', 'Crystal (Palace of Darkness)', 'Crystal (Swamp Palace)', 'Crystal (Skull Woods)', "Crystal (Thieves' Town)", 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Crystal (Turtle Rock)']],
            ["Ganons Tower - Hope Room - Left", True, ['Pegasus Boots', 'Moon Pearl', 'Crystal (Palace of Darkness)', 'Crystal (Swamp Palace)', 'Crystal (Skull Woods)', "Crystal (Thieves' Town)", 'Crystal (Ice Palace)', 'Crystal (Misery Mire)', 'Crystal (Turtle Rock)']],
        ])