...
class TestEntrances(TestInvertedMinor):
    ...
    def testDungeonEntrances(self):
        self.run_entrance_tests([
            ...
            ["Inverted Ganons Tower", False, [], ["Crystal (Palace of Darkness)"]],
            ["Inverted Ganons Tower", False, [], ["Crystal (Swamp Palace)"]],
            ["Inverted Ganons Tower", False, [], ["Crystal (Skull Woods)"]],
            ["Inverted Ganons Tower", False, [], ["Crystal (Thieves' Town)"]],
            ["Inverted Ganons Tower", False, [], ["Crystal (Ice Palace)"]],
            ["Inverted Ganons Tower", False, [], ["Crystal (Misery Mire)"]],
            ["Inverted Ganons Tower", False, [], ["Crystal (Turtle Rock)"]],
            ["Inverted Ganons Tower", True, ["Beat Agahnim 1", "Crystal (Palace of Darkness)", "Crystal (Swamp Palace)", "Crystal (Skull Woods)", "Crystal (Thieves' Town)", "Crystal (Ice Palace)", "Crystal (Misery Mire)", "Crystal (Turtle Rock)"]],
            ["Inverted Ganons Tower", True, ["Moon Pearl", "Progressive Glove", "Progressive Glove", "Crystal (Palace of Darkness)", "Crystal (Swamp Palace)", "Crystal (Skull Woods)", "Crystal (Thieves' Town)", "Crystal (Ice Palace)", "Crystal (Misery Mire)", "Crystal (Turtle Rock)"]],
        ])