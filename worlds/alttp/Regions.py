...
def create_regions(multiworld: MultiWorld, player: int):
    ...
    multiworld.regions += [
        ...
        create_dungeon_region(multiworld, player, 'Eastern Palace', 'Eastern Palace', ['Eastern Palace - Cannonball Chest',
                                                                           'Eastern Palace - Map Chest'], ['Eastern Palace Exit', 'Eastern Palace Beyond Stalfos Room']),
        create_dungeon_region(multiworld, player, 'Eastern Palace (Beyond Stalfos Room)', 'Eastern Palace',
                              ['Eastern Palace - Compass Chest', 'Eastern Palace - Big Chest', 'Eastern Palace - Dark Square Pot Key',
                               'Eastern Palace - Dark Eyegore Key Drop', 'Eastern Palace - Big Key Chest',
                               'Eastern Palace - Boss', 'Eastern Palace - Prize']),
        ...
        create_dungeon_region(multiworld, player, 'Swamp Palace (Starting Area)', 'Swamp Palace', ['Swamp Palace - Map Chest', 'Swamp Palace - Pot Row Pot Key',
                                                                                       'Swamp Palace - Trench 1 Pot Key', 'Swamp Palace - Hookshot Pot Key'], ['Swamp Palace (Center)']),
        create_dungeon_region(multiworld, player, 'Swamp Palace (Center)', 'Swamp Palace', ['Swamp Palace - Big Chest', 'Swamp Palace - Compass Chest',
        ...
        create_dungeon_region(multiworld, player, 'Thieves Town (Entrance)', 'Thieves\' Town', ['Thieves\' Town - Big Key Chest',
                                                                            ...
                                                                            'Thieves\' Town - Hallway Pot Key'], ['Thieves Town Big Key Door', 'Thieves Town Exit']),
...
location_table: typing.Dict[str,
    ...
    {'Mushroom': (0x180013, 0x186338, False, 'in the woods'),
     ...
     'Eastern Palace - Prize': (boss_prize_location_table['Eastern Palace - Prize'].item_address,
                                boss_prize_location_table['Eastern Palace - Prize'].player_address, True, 'with the boss of Eastern Palace'),
     'Desert Palace - Prize': (boss_prize_location_table['Desert Palace - Prize'].item_address,
                               boss_prize_location_table['Desert Palace - Prize'].player_address, True, 'with the boss of Desert Palace'),
     'Tower of Hera - Prize': (boss_prize_location_table['Tower of Hera - Prize'].item_address,
                               boss_prize_location_table['Tower of Hera - Prize'].player_address, True, 'with the boss of Tower of Hera'),
     'Palace of Darkness - Prize': (boss_prize_location_table['Palace of Darkness - Prize'].item_address,
                                    boss_prize_location_table['Palace of Darkness - Prize'].player_address, True, 'with the boss of Palace of Darkness'),
     'Swamp Palace - Prize': (boss_prize_location_table['Swamp Palace - Prize'].item_address,
                              boss_prize_location_table['Swamp Palace - Prize'].player_address, True, 'with the boss of Swamp Palace'),
     'Thieves\' Town - Prize': (boss_prize_location_table['Thieves\' Town - Prize'].item_address,
                                boss_prize_location_table['Thieves\' Town - Prize'].player_address, True, 'with the boss of Thieves\' Town'),
     'Skull Woods - Prize': (boss_prize_location_table['Skull Woods - Prize'].item_address,
                             boss_prize_location_table['Skull Woods - Prize'].player_address, True, 'with the boss of Skull Woods'),
     'Ice Palace - Prize': (boss_prize_location_table['Ice Palace - Prize'].item_address,
                            boss_prize_location_table['Ice Palace - Prize'].player_address, True, 'with the boss of Ice Palace'),
     'Misery Mire - Prize': (boss_prize_location_table['Misery Mire - Prize'].item_address,
                             boss_prize_location_table['Misery Mire - Prize'].player_address, True, 'with the boss of Misery Mire'),
     'Turtle Rock - Prize': (boss_prize_location_table['Turtle Rock - Prize'].item_address,
                             boss_prize_location_table['Turtle Rock - Prize'].player_address, True, 'with the boss of Turtle Rock')}
...
lookup_vanilla_location_to_entrance = {
    ...
    1573269: 'Eastern Palace',
    1573270: 'Desert Palace Entrance (North)',
    1573271: 'Tower of Hera',
    1573272: 'Palace of Darkness',
    1573273: 'Swamp Palace',
    1573274: 'Skull Woods Final Section',
    1573275: 'Thieves Town',
    1573276: 'Ice Palace',
    1573277: 'Misery Mire',
    1573278: 'Turtle Rock Isolated Ledge Entrance',
