...
item_data_table: dict[Items, SohItemData] = {
    ...
    Items.GOLD_SKULLTULA_TOKEN: SohItemData(38, IC.useful | IC.deprioritized | IC.skip_balancing, 0, item_groups=["Tokens", "Token"]),
    ...
    Items.PROGRESSIVE_BOMB_BAG: SohItemData(41, IC.progression | IC.useful, 1, item_groups=["Bomb Bag", "Bombs"]),
    Items.PROGRESSIVE_BOW: SohItemData(42, IC.progression | IC.useful, 1, item_groups=["Bow"]),
    Items.PROGRESSIVE_SLINGSHOT: SohItemData(43, IC.progression | IC.useful, 1, item_groups=["Slingshot"]),
    ...
    Items.PROGRESSIVE_NUT_CAPACITY: SohItemData(46, IC.progression | IC.useful, 0, item_groups=["Deku Nut Bag"]),
    ...
    Items.PROGRESSIVE_MAGIC_METER: SohItemData(49, IC.progression | IC.useful, 1, item_groups=["Magic Meter"]),
